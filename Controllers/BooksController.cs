...
namespace SchoolLibrary.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string sortItem)
        {
            ...
            {
                case "descending":
                    books = sortItem == "name" ? books.OrderByDescending(p => p.title) : books.OrderByDescending(p => p.price);
                    break;
                case "ascending":
                    books = sortItem == "name" ? books.OrderBy(p => p.title) : books.OrderBy(p => p.price);
                    break;
                default:
                    break;
            }
